...
const FormularioCrearClases = () => {
  ...
  const { edificios, clases, docentes, aulas, } = useFetchs(docente[0]?.carrera, centro[0]?.nombre_centro);
        ...
        <div>
          ...
          <div>
            <div>
              ...
              <select id="clase" value={selectedClase} onChange={handleClaseChange}>
            ...
            <div>
              ...
              <select id="docente" value={selectedDocente} onChange={handleDocenteChange}>
                <option value="">Opciones</option>
                {docentes.map(docente => (
                  <option key={docente.num_empleado} value={docente.num_empleado}>
            ...
            <div>
              ...
              <select id="edificio" value={selectedEdificio} onChange={handleEdificioChange}>
                <option value="">Opciones</option>
            ...
            <div>
              ...
              <select id="aulas" value={selectedAula} onChange={handleAulaChange}>
                <option value="">Opciones</option>
                {aulas.map(aula => (
                  <option key={aula.id_aula} value={aula.id_aula}>
                    {/* {aula.nombre} - {aula.num_aula} - Hi:{aula.horainicio} - Hf:{aula.horafin} */}
                    {aula.num_aula} - Hi:{aula.horainicio} - Hf:{aula.horafin}
                  </option>
                ))}
              </select>
            </div>
            ...
            <div>
              ...
              <select id="dias" value={selectedDias} onChange={handleDiasChange}>
                <option value="">Opciones</option>
            ...
            <div>
              ...
              <input type="number" value={cuposDisponibles} onChange={handleCuposChange} placeholder="Ingrese el número de cupos disponibles" />
            </div>
