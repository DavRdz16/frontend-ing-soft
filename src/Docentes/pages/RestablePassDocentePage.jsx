...
export const RestablePassDocentePage = () => {
    ...
    const handleSubmit = (event) => {
        ...
        const expiration = new URLSearchParams(window.location.search).get('expires');
        ...
        if (Date.now() > parseInt(expiration, 10)) {
            setMessage('El enlace ha expirado. Por favor, solicita un nuevo enlace de recuperación de contraseña.');
            return;
        }
            ...
            <div className="form">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input
                        ...
                        required
                    />
                    <button type="submit" disabled={message === 'Contraseña restablecida exitosamente.' || message === 'El enlace ha expirado. Por favor, solicita un nuevo enlace de recuperación de contraseña.' || submitButtonDisabled}>Restablecer contraseña</button>
                </form>
                {message && (
                    <div role="alert">
                        {(() => {
                            switch (message) {
                                ...
                                case 'El enlace ha expirado. Por favor, solicita un nuevo enlace de recuperación de contraseña.':
                                    return (
                                        <>
                                            <div className="alert alert-warning p-1 mt-2" role="alert">
                                                {message}
                                            </div>
