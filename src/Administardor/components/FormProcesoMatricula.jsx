    ...
    <>
      ...
      {/* 
              ...
              <div className="col">
                ...
                <label className="col-4" htmlFor="restricion2">
                  Restrición 2:
                </label>
                <input
                  className="col-8 f-w form-control"
                ...
                />
                <div className="col">
                  <label className="col-4" htmlFor="fecha2">
                    Fecha de inicio:
                  </label>
                  <DatePicker
                    className="col-8 f-w form-control"
              ...
              <div className="col">
                ...
                <label className="col-4" htmlFor="restricion3">
                  Restrición 3:
                </label>
                <input
                  className="col-8 f-w form-control"
                ...
                />
                <div className="col">
                  <label className="col-4" htmlFor={"fecha3"}>
                    Fecha de inicio:
                  </label>
                  <DatePicker
                    className="col-8 f-w form-control"
              ...
              <div className="col">
                ...
                <label className="col-4" htmlFor="restricion4">
                  Restrición 4:
                </label>
                <input
                  className="col-8 f-w form-control"
                ...
                />
                <div className="col">
                  <label className="col-4" htmlFor="fecha4">
                    Fecha de inicio:
                  </label>
                  <DatePicker
              ...
              <div className="col">
                ...
                <label className="col-4" htmlFor={"restricion5"}>
                  Restrición 5:
                </label>
                <input
                  className="col-8 f-w form-control"
                ...
                />
                <div className="col">
                  <label className="col-4" htmlFor={"fecha5"}>
                    Fecha de inicio:
                  </label>
                  <DatePicker
                    className="col-8 f-w form-control"
