...
export const RegistroDocete = () => {
  ...
  const { formState, errors, loading, handleChange, handleSubmit, onResetForm } = useFormDocente(initialData, onValidation)
          ...
          <form onSubmit={handleSubmit}>
            <div className="d-flex flex-wrap">
              <div className="mb-3 me-4">
                ...
                />
                {errors.nombres && <div className="alert alert-danger p-1" role="alert">
                  {errors.nombres}
                </div>}
              </div>
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={handleChange}
                />
                {errors.apellidos && <div className="alert alert-danger p-1" role="alert">
                  {errors.apellidos}
                </div>}
              </div>
            </div>
            <div className="mb-3">
              ...
              <input
                ...
                onChange={handleChange}
              />
              {errors.identidad && <div className="alert alert-danger p-1" role="alert">
                {errors.identidad}
              </div>}
            </div>
            <div className="d-flex flex-wrap">
              <div className="mb-3 me-4">
                ...
                <input
                  ...
                  onChange={handleChange}
                />
                {errors.email && <div className="alert alert-danger p-1" role="alert">
                  {errors.email}
                </div>}              </div>
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={handleChange}
                />
                {errors.password && <div className="alert alert-danger p-1" role="alert">
                  {errors.password}
                </div>}
                <div className="mb-3">
                  <label htmlFor="password">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                  />
                  {errors.password2 && <div className="alert alert-danger p-1" role="alert">
                    {errors.password2}
                  </div>}
                </div>
              </div>
